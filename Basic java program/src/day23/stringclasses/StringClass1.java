...
public class StringClass1 {
	...
	public static void main(String[] args) {
		...
		//1.using literals
		String s1="Mumbai";//new object will be created in constant pool
		 ...
		 */
		System.out.println("s1 & s2 using equals() : "+s1.equals(s2));//based on values
		System.out.println("s1 & s2 using == : "+(s1==s2));//based on object
		
		System.out.println("s1 & s3 using equals() : "+s1.equals(s3));//compare s1 and s3 values
		System.out.println("s1 & s3 using == : "+(s1==s3));//compare object
