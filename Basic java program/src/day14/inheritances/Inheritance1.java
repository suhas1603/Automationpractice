...
/*
 * B1: Child class/sub class/ derived class A1: Parent class/ super class/
 * Inherited class All the non-static member of A1 class will inherited into B1
 * class (A1 non-static members will be present virtually in class B1)
 */
class B1 extends A1 {
	// default constructor with default super statement
	static int x = 30;
	/*
	 * These non-static member of A1 class are virtually present in B1 class int
	 * b=20; double c=13.45;
	 */
	int y = 40;
	double z = 53.45;
...
class C1 extends B1 {
	...
	static int p = 50;
	/*
	 * These non-static member of B1 class are virtually present in C1 class int
	 * b=20; double c=13.45; int y=40; double z=53.45;
	 */
	int q = 60;
	double r = 66.45;
}
...
public class Inheritance1 {
	...
	public static void main(String[] args) {
		...
		C1 c1 = new C1();
		// it will have all the non-static members of class A1,B1 & C1--->b,c,y,z,q,r
		...
		System.out.println("*********************************");
		B1 b1 = new B1();
		// it will have all the non-static members of class A1,B1--->b,c,y,z
